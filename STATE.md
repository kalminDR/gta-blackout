...
Generated **2026-09-11 17:15 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **234 snapshots** over 224.0 hours (9.3 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-11/1714.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-11 17:14 UTC`
- 234 of ~224 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/234 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/234 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/234 | never returned a number |
| 🔴 | `deviations` | 0/234 | never returned a number |
| 🔴 | `listings_uk_ps5` | 130/234 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 130/234 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 130/234 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 130/234 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 130/234 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 130/234 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 194/234 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 227/234 | frozen at 21 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 222/234 | zero in 13 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 218/234 | zero in 21 of 24 readings |
| 🔴 | `yt_subscribers` | 230/234 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 218/234 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
