...
Generated **2026-09-26 07:25 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **347 snapshots** over 574.2 hours (23.9 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-26/0725.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-26 07:25 UTC`
- 347 of ~575 expected hourly readings
- **70 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/347 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/347 | never returned a number — source not authenticating |
| 🔴 | `listings_de_xbox_series_x` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 243/347 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 307/347 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 337/347 | frozen at 8 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 342/347 | zero in 10 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 335/347 | zero in 12 of 24 readings |
| 🔴 | `yt_subscribers` | 343/347 | frozen at 1.38e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 271/347 | missing 17 of 18 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 208/347 | missing 17 of 18 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 242/347 | missing 17 of 18 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 237/347 | missing 17 of 18 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 269/347 | missing 17 of 18 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 213/347 | missing 17 of 18 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 242/347 | missing 17 of 18 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 236/347 | missing 17 of 18 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 242/347 | missing 17 of 18 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 271/347 | missing 17 of 18 since it started |
| 🟠 | `yt_subscribers_per_hour` | 271/347 | missing 17 of 18 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 242/347 | missing 17 of 18 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 238/347 | missing 17 of 18 since it started |
