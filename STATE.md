...
Generated **2026-09-18 07:17 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **303 snapshots** over 382.0 hours (15.9 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-18/0716.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-18 07:16 UTC`
- 303 of ~383 expected hourly readings
- **26 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/303 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/303 | never returned a number — source not authenticating |
| 🔴 | `listings_uk_ps5_pro` | 199/303 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 199/303 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 199/303 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 199/303 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 199/303 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 263/303 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 291/303 | zero in 14 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 291/303 | zero in 13 of 24 readings |
| 🔴 | `yt_subscribers` | 299/303 | frozen at 1.37e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 264/303 | missing 21 of 23 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 202/303 | missing 21 of 23 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 235/303 | missing 21 of 23 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 232/303 | missing 21 of 23 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 262/303 | missing 21 of 23 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 207/303 | missing 21 of 23 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 235/303 | missing 21 of 23 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 229/303 | missing 21 of 23 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 235/303 | missing 21 of 23 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 264/303 | missing 21 of 23 since it started |
| 🟠 | `yt_subscribers_per_hour` | 264/303 | missing 21 of 23 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 235/303 | missing 21 of 23 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 231/303 | missing 21 of 23 since it started |
