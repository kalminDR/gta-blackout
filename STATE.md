...
Generated **2026-09-18 12:52 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **304 snapshots** over 387.6 hours (16.2 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-18/1251.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-18 12:51 UTC`
- 304 of ~388 expected hourly readings
- **27 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/304 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/304 | never returned a number — source not authenticating |
| 🔴 | `listings_uk_ps5_pro` | 200/304 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 200/304 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 200/304 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 200/304 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 200/304 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 264/304 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 292/304 | zero in 13 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 292/304 | zero in 12 of 24 readings |
| 🔴 | `yt_subscribers` | 300/304 | frozen at 1.37e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 264/304 | missing 22 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 202/304 | missing 22 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 235/304 | missing 22 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 232/304 | missing 22 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 262/304 | missing 22 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 207/304 | missing 22 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 235/304 | missing 22 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 229/304 | missing 22 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 235/304 | missing 22 of 24 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 264/304 | missing 22 of 24 since it started |
| 🟠 | `yt_subscribers_per_hour` | 264/304 | missing 22 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 235/304 | missing 22 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 231/304 | missing 22 of 24 since it started |
