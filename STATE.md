...
Generated **2026-09-06 23:16 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **120 snapshots** over 110.0 hours (4.6 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-06/2314.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-06 23:14 UTC`
- 120 of ~110 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/120 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/120 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/120 | never returned a number |
| 🔴 | `deviations` | 0/120 | never returned a number |
| 🔴 | `polymarket_market_count` | 80/120 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 114/120 | frozen at 20 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 115/120 | zero in 13 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 108/120 | zero in 14 of 24 readings |
| 🔴 | `traffic_newyork_delay_pct` | 108/120 | zero in 11 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 108/120 | zero in 15 of 24 readings |
| 🔴 | `twitch_gta5` | 117/120 | zero in 16 of 24 readings |
| 🔴 | `yt_QdBZY2fkU-0_likes_per_hour` | 73/120 | never returned a number |
| 🔴 | `yt_rockstar_views_per_hour` | 104/120 | zero in 22 of 24 readings |
| 🔴 | `yt_subscribers` | 116/120 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 104/120 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 61/120 | missing 12 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 50/120 | missing 5 of 8 since it started |
...
Baseline needs 6 samples per hour-of-week bucket. **1 of 168 buckets qualify** (109 seen at all). Nulls here are correct behaviour, not a bug: the page refuses to print a number it cannot support.
