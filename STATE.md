...
Generated **2026-09-23 16:39 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **333 snapshots** over 511.4 hours (21.3 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-23/1638.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-23 16:38 UTC`
- 333 of ~512 expected hourly readings
- **56 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/333 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/333 | never returned a number — source not authenticating |
| 🔴 | `listings_de_xbox_series_x` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 229/333 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 293/333 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 323/333 | frozen at 8 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 321/333 | zero in 13 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 321/333 | zero in 12 of 24 readings |
| 🟠 | `hn_items_per_hour` | 271/333 | missing 15 of 21 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 208/333 | missing 15 of 20 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 242/333 | missing 15 of 21 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 237/333 | missing 15 of 20 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 269/333 | missing 15 of 21 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 213/333 | missing 15 of 20 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 242/333 | missing 15 of 21 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 236/333 | missing 15 of 21 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 242/333 | missing 15 of 21 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 271/333 | missing 15 of 21 since it started |
| 🟠 | `yt_subscribers_per_hour` | 271/333 | missing 15 of 21 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 242/333 | missing 15 of 21 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 238/333 | missing 15 of 21 since it started |
