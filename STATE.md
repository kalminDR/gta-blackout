...
Generated **2026-09-15 09:57 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **288 snapshots** over 312.7 hours (13.0 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-15/0957.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-15 09:57 UTC`
- 288 of ~313 expected hourly readings
- **11 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/288 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/288 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/288 | never returned a number |
| 🔴 | `deviations` | 0/288 | never returned a number |
| 🔴 | `listings_uk_ps5_pro` | 184/288 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 184/288 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 184/288 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 184/288 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 184/288 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 248/288 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_berlin_delay_pct` | 276/288 | zero in 10 of 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 283/288 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 276/288 | zero in 18 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 189/288 | zero in 15 of 24 readings |
| 🔴 | `traffic_newyork_delay_pct` | 276/288 | zero in 11 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 276/288 | zero in 13 of 24 readings |
| 🔴 | `yt_subscribers` | 284/288 | frozen at 1.37e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 264/288 | missing 8 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 202/288 | missing 10 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 235/288 | missing 8 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 232/288 | missing 8 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 262/288 | missing 8 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 207/288 | missing 8 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 235/288 | missing 8 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 229/288 | missing 8 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 235/288 | missing 8 of 24 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 264/288 | missing 8 of 24 since it started |
| 🟠 | `yt_subscribers_per_hour` | 264/288 | missing 8 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 235/288 | missing 8 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 231/288 | missing 8 of 24 since it started |

**Repaired.** These were failing earlier in the record and are clean across the last 24 readings. Listed so the fix is visible, and so nobody fixes it twice: `power_de_lag_hours`, `power_de_load_mw`, `power_es_lag_hours`, `power_es_load_mw`, `power_fr_lag_hours`, `power_fr_load_mw`, `power_hu_lag_hours`, `power_hu_load_mw`, `power_it_lag_hours`, `power_it_load_mw`, `power_nl_lag_hours`, `power_nl_load_mw`, `power_pl_lag_hours`, `power_pl_load_mw`, `power_se_lag_hours`, `power_se_load_mw`, `traffic_losangeles_seconds_measured`, `traffic_losangeles_travel_index`.
