...
Generated **2026-09-12 10:15 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **251 snapshots** over 241.0 hours (10.0 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-12/1014.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-12 10:14 UTC`
- 251 of ~241 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/251 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/251 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/251 | never returned a number |
| 🔴 | `deviations` | 0/251 | never returned a number |
| 🔴 | `listings_uk_ps5` | 147/251 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 147/251 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 147/251 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 147/251 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 147/251 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 147/251 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 211/251 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 246/251 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 239/251 | zero in 14 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 239/251 | zero in 11 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 235/251 | zero in 22 of 24 readings |
| 🔴 | `yt_subscribers` | 247/251 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 235/251 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `power_it_lag_hours` | 75/251 | missing 7 of 24 since it started |
| 🟠 | `power_it_load_mw` | 75/251 | missing 7 of 24 since it started |
