...
Generated **2026-09-07 06:24 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **127 snapshots** over 117.1 hours (4.9 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-07/0623.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-07 06:23 UTC`
- 127 of ~118 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/127 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/127 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/127 | never returned a number |
| 🔴 | `deviations` | 0/127 | never returned a number |
| 🔴 | `listings_uk_xbox_series_x` | 23/127 | frozen at 100 for all 23 readings |
| 🔴 | `listings_us_ps5` | 23/127 | frozen at 100 for all 23 readings |
| 🔴 | `listings_us_ps5_pro` | 23/127 | frozen at 100 for all 23 readings |
| 🔴 | `listings_us_xbox_series_x` | 23/127 | frozen at 100 for all 23 readings |
| 🔴 | `polymarket_market_count` | 87/127 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 121/127 | frozen at 20 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 122/127 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 115/127 | zero in 14 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 28/127 | zero in 15 of 22 readings |
| 🔴 | `traffic_newyork_delay_pct` | 115/127 | zero in 10 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 115/127 | zero in 14 of 24 readings |
| 🔴 | `twitch_gta5` | 124/127 | zero in 13 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 111/127 | zero in 22 of 24 readings |
| 🔴 | `yt_subscribers` | 123/127 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 111/127 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 67/127 | missing 9 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 56/127 | missing 6 of 15 since it started |
...
Baseline needs 6 samples per hour-of-week bucket. **1 of 168 buckets qualify** (116 seen at all). Nulls here are correct behaviour, not a bug: the page refuses to print a number it cannot support.
