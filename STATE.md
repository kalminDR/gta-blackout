...
Generated **2026-09-24 04:20 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **336 snapshots** over 523.1 hours (21.8 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-24/0419.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-24 04:19 UTC`
- 336 of ~524 expected hourly readings
- **59 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/336 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/336 | never returned a number — source not authenticating |
| 🔴 | `listings_de_xbox_series_x` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 232/336 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 296/336 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 326/336 | frozen at 8 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 331/336 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 324/336 | zero in 14 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 324/336 | zero in 15 of 24 readings |
| 🟠 | `hn_items_per_hour` | 271/336 | missing 18 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 208/336 | missing 18 of 23 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 242/336 | missing 18 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 237/336 | missing 18 of 23 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 269/336 | missing 18 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 213/336 | missing 18 of 23 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 242/336 | missing 18 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 236/336 | missing 18 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 242/336 | missing 18 of 24 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 271/336 | missing 18 of 24 since it started |
| 🟠 | `yt_subscribers_per_hour` | 271/336 | missing 18 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 242/336 | missing 18 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 238/336 | missing 18 of 24 since it started |

**Repaired.** These were failing earlier in the record and are clean across the last 24 readings. Listed so the fix is visible, and so nobody fixes it twice: `power_de_lag_hours`, `power_de_load_mw`, `power_es_lag_hours`, `power_es_load_mw`, `power_fr_lag_hours`, `power_fr_load_mw`, `power_hu_lag_hours`, `power_hu_load_mw`, `power_it_lag_hours`, `power_it_load_mw`, `power_nl_lag_hours`, `power_nl_load_mw`, `power_pl_lag_hours`, `power_pl_load_mw`, `power_se_lag_hours`, `power_se_load_mw`, `traffic_losangeles_delay_pct`, `traffic_losangeles_seconds_measured`, `traffic_losangeles_travel_index`.
