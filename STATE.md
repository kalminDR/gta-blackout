...
Generated **2026-09-13 05:15 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **270 snapshots** over 260.0 hours (10.8 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-13/0514.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-13 05:14 UTC`
- 270 of ~260 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/270 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/270 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/270 | never returned a number |
| 🔴 | `deviations` | 0/270 | never returned a number |
| 🔴 | `listings_uk_ps5` | 166/270 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 166/270 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 166/270 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 166/270 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 166/270 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 166/270 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 230/270 | frozen at 6 for all 24 readings |
| 🔴 | `price_de_xbox_series_x` | 166/270 | frozen at 594.63 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 263/270 | frozen at 9 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 263/270 | frozen at 22 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 258/270 | zero in 14 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 171/270 | zero in 13 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 254/270 | zero in 22 of 24 readings |
| 🔴 | `yt_subscribers` | 266/270 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 254/270 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |

**Repaired.** These were failing earlier in the record and are clean across the last 24 readings. Listed so the fix is visible, and so nobody fixes it twice: `power_de_lag_hours`, `power_de_load_mw`, `power_es_lag_hours`, `power_es_load_mw`, `power_fr_lag_hours`, `power_fr_load_mw`, `power_hu_lag_hours`, `power_hu_load_mw`, `power_it_lag_hours`, `power_it_load_mw`, `power_nl_lag_hours`, `power_nl_load_mw`, `power_pl_lag_hours`, `power_pl_load_mw`, `power_se_lag_hours`, `power_se_load_mw`, `traffic_budapest_delay_pct`, `traffic_losangeles_seconds_measured`, `traffic_losangeles_travel_index`, `traffic_warsaw_delay_pct`.
