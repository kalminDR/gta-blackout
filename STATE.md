...
Generated **2026-09-08 21:18 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **166 snapshots** over 156.0 hours (6.5 days); last one 0.1 h ago

## Sources

Newest snapshot: `data/2026-09-08/2114.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-08 21:14 UTC`
- 166 of ~156 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/166 | never returned a number — source not authenticating |
| 🔴 | `power_*` (5 metrics) | 0/166 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/166 | never returned a number |
| 🔴 | `deviations` | 0/166 | never returned a number |
| 🔴 | `listings_uk_ps5_pro` | 62/166 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 62/166 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 62/166 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 62/166 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 62/166 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 126/166 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 160/166 | frozen at 20 for all 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 67/166 | zero in 12 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 154/166 | zero in 11 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 150/166 | zero in 21 of 24 readings |
| 🔴 | `yt_subscribers` | 162/166 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 150/166 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `power_de_lag_hours` | 28/166 | missing 3 of 4 since it started |
| 🟠 | `power_de_load_mw` | 28/166 | missing 3 of 4 since it started |
| 🟠 | `power_es_lag_hours` | 28/166 | missing 1 of 2 since it started |
| 🟠 | `power_es_load_mw` | 28/166 | missing 1 of 2 since it started |
| 🟠 | `power_fr_lag_hours` | 27/166 | missing 3 of 4 since it started |
| 🟠 | `power_fr_load_mw` | 27/166 | missing 3 of 4 since it started |
| 🟠 | `power_hu_lag_hours` | 29/166 | missing 2 of 4 since it started |
| 🟠 | `power_hu_load_mw` | 29/166 | missing 2 of 4 since it started |
| 🟠 | `power_nl_lag_hours` | 28/166 | missing 2 of 4 since it started |
| 🟠 | `power_nl_load_mw` | 28/166 | missing 2 of 4 since it started |
| 🟠 | `power_pl_lag_hours` | 28/166 | missing 3 of 4 since it started |
| 🟠 | `power_pl_load_mw` | 28/166 | missing 3 of 4 since it started |
| 🟠 | `power_se_lag_hours` | 27/166 | missing 3 of 4 since it started |
| 🟠 | `power_se_load_mw` | 27/166 | missing 3 of 4 since it started |
...
Baseline needs 6 samples per hour-of-week bucket. **1 of 168 buckets qualify** (155 seen at all). Nulls here are correct behaviour, not a bug: the page refuses to print a number it cannot support.
