...
Generated **2026-09-07 16:18 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **137 snapshots** over 127.0 hours (5.3 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-07/1616.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-07 16:16 UTC`
- 137 of ~128 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/137 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/137 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/137 | never returned a number |
| 🔴 | `deviations` | 0/137 | never returned a number |
| 🔴 | `listings_uk_xbox_series_x` | 33/137 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 33/137 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 33/137 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 33/137 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 97/137 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 131/137 | frozen at 20 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 125/137 | zero in 12 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 38/137 | zero in 18 of 24 readings |
| 🔴 | `traffic_newyork_delay_pct` | 125/137 | zero in 11 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 125/137 | zero in 11 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 121/137 | zero in 23 of 24 readings |
| 🔴 | `yt_subscribers` | 133/137 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 121/137 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
...
Baseline needs 6 samples per hour-of-week bucket. **1 of 168 buckets qualify** (126 seen at all). Nulls here are correct behaviour, not a bug: the page refuses to print a number it cannot support.
