...
Generated **2026-09-12 15:15 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **256 snapshots** over 246.0 hours (10.2 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-12/1514.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-12 15:14 UTC`
- 256 of ~246 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/256 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/256 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/256 | never returned a number |
| 🔴 | `deviations` | 0/256 | never returned a number |
| 🔴 | `listings_uk_ps5` | 152/256 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 152/256 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 152/256 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 152/256 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 152/256 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 152/256 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 216/256 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 251/256 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 244/256 | zero in 12 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 157/256 | zero in 12 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 244/256 | zero in 11 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 240/256 | zero in 23 of 24 readings |
| 🔴 | `yt_subscribers` | 252/256 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 240/256 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `power_it_lag_hours` | 80/256 | missing 7 of 24 since it started |
| 🟠 | `power_it_load_mw` | 80/256 | missing 7 of 24 since it started |
