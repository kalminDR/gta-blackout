...
Generated **2026-09-12 23:15 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **264 snapshots** over 254.0 hours (10.6 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-12/2314.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-12 23:14 UTC`
- 264 of ~254 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/264 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/264 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/264 | never returned a number |
| 🔴 | `deviations` | 0/264 | never returned a number |
| 🔴 | `listings_uk_ps5` | 160/264 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 160/264 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 160/264 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 160/264 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 160/264 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 160/264 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 224/264 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 259/264 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 252/264 | zero in 13 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 165/264 | zero in 13 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 248/264 | zero in 22 of 24 readings |
| 🔴 | `yt_subscribers` | 260/264 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 248/264 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `power_it_lag_hours` | 88/264 | missing 7 of 24 since it started |
| 🟠 | `power_it_load_mw` | 88/264 | missing 7 of 24 since it started |
