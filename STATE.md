...
Generated **2026-09-14 23:48 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **286 snapshots** over 302.6 hours (12.6 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-14/2348.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-14 23:48 UTC`
- 286 of ~303 expected hourly readings
- **9 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/286 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/286 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/286 | never returned a number |
| 🔴 | `deviations` | 0/286 | never returned a number |
| 🔴 | `listings_uk_ps5_pro` | 182/286 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 182/286 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 182/286 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 182/286 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 182/286 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 246/286 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_berlin_delay_pct` | 274/286 | zero in 10 of 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 281/286 | zero in 12 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 274/286 | zero in 18 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 187/286 | zero in 13 of 24 readings |
| 🔴 | `traffic_newyork_delay_pct` | 274/286 | zero in 10 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 274/286 | zero in 13 of 24 readings |
| 🔴 | `yt_subscribers` | 282/286 | frozen at 1.37e+07 for all 24 readings |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 202/286 | missing 8 of 24 since it started |

**Repaired.** These were failing earlier in the record and are clean across the last 24 readings. Listed so the fix is visible, and so nobody fixes it twice: `power_de_lag_hours`, `power_de_load_mw`, `power_es_lag_hours`, `power_es_load_mw`, `power_fr_lag_hours`, `power_fr_load_mw`, `power_hu_lag_hours`, `power_hu_load_mw`, `power_it_lag_hours`, `power_it_load_mw`, `power_nl_lag_hours`, `power_nl_load_mw`, `power_pl_lag_hours`, `power_pl_load_mw`, `power_se_lag_hours`, `power_se_load_mw`, `traffic_losangeles_seconds_measured`, `traffic_losangeles_travel_index`, `yt_rockstar_views_per_hour`, `yt_subscribers_per_hour`.
