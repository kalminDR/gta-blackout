...
Generated **2026-09-13 20:37 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **280 snapshots** over 275.4 hours (11.5 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-13/2036.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-13 20:36 UTC`
- 280 of ~276 expected hourly readings
- **3 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/280 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/280 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/280 | never returned a number |
| 🔴 | `deviations` | 0/280 | never returned a number |
| 🔴 | `listings_uk_ps5_pro` | 176/280 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 176/280 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 176/280 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 176/280 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 176/280 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 240/280 | frozen at 6 for all 24 readings |
| 🔴 | `price_de_xbox_series_x` | 176/280 | frozen at 594.63 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 273/280 | frozen at 9 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 273/280 | frozen at 22 for all 24 readings |
| 🔴 | `traffic_berlin_delay_pct` | 268/280 | zero in 10 of 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 275/280 | zero in 11 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 268/280 | zero in 18 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 181/280 | zero in 12 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 262/280 | zero in 20 of 22 readings |
| 🔴 | `yt_subscribers` | 276/280 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 262/280 | frozen at 0 for all 22 readings; zero in 22 of 22 readings |
