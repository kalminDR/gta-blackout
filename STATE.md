...
Generated **2026-09-10 19:13 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **212 snapshots** over 202.0 hours (8.4 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-10/1913.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-10 19:13 UTC`
- 212 of ~202 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/212 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/212 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/212 | never returned a number |
| 🔴 | `deviations` | 0/212 | never returned a number |
| 🔴 | `listings_uk_ps5_pro` | 108/212 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 108/212 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 108/212 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 108/212 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 108/212 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 172/212 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 205/212 | frozen at 6 for all 23 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 200/212 | zero in 11 of 24 readings |
| 🔴 | `yt_rockstar_views_per_hour` | 196/212 | zero in 21 of 24 readings |
| 🔴 | `yt_subscribers` | 208/212 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 196/212 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `power_it_lag_hours` | 43/212 | missing 6 of 22 since it started |
| 🟠 | `power_it_load_mw` | 43/212 | missing 6 of 22 since it started |
