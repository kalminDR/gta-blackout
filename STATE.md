...
Generated **2026-09-19 04:13 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **308 snapshots** over 403.0 hours (16.8 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-19/0412.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-19 04:12 UTC`
- 308 of ~403 expected hourly readings
- **31 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/308 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/308 | never returned a number — source not authenticating |
| 🔴 | `listings_uk_ps5_pro` | 204/308 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 204/308 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 204/308 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 204/308 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 204/308 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 268/308 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 303/308 | zero in 10 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 296/308 | zero in 12 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 296/308 | zero in 11 of 24 readings |
| 🔴 | `yt_subscribers` | 304/308 | frozen at 1.37e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 265/308 | missing 21 of 23 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 203/308 | missing 21 of 23 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 236/308 | missing 21 of 23 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 232/308 | missing 22 of 23 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 263/308 | missing 21 of 23 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 208/308 | missing 21 of 23 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 236/308 | missing 21 of 23 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 230/308 | missing 21 of 23 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 236/308 | missing 21 of 23 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 265/308 | missing 21 of 23 since it started |
| 🟠 | `yt_subscribers_per_hour` | 265/308 | missing 21 of 23 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 236/308 | missing 21 of 23 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 232/308 | missing 21 of 23 since it started |
