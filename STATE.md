...
Generated **2026-09-26 17:02 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **349 snapshots** over 583.8 hours (24.3 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-26/1700.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-26 17:00 UTC`
- 349 of ~584 expected hourly readings
- **72 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/349 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/349 | never returned a number — source not authenticating |
| 🔴 | `listings_de_xbox_series_x` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_ps5_pro` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 245/349 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 309/349 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5` | 339/349 | frozen at 8 for all 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 337/349 | zero in 10 of 24 readings |
| 🔴 | `yt_subscribers` | 345/349 | frozen at 1.38e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 271/349 | missing 19 of 20 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 208/349 | missing 19 of 20 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 242/349 | missing 19 of 20 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 237/349 | missing 19 of 20 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 269/349 | missing 19 of 20 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 213/349 | missing 19 of 20 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 242/349 | missing 19 of 20 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 236/349 | missing 19 of 20 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 242/349 | missing 19 of 20 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 271/349 | missing 19 of 20 since it started |
| 🟠 | `yt_subscribers_per_hour` | 271/349 | missing 19 of 20 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 242/349 | missing 19 of 20 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 238/349 | missing 19 of 20 since it started |

**Repaired.** These were failing earlier in the record and are clean across the last 24 readings. Listed so the fix is visible, and so nobody fixes it twice: `power_de_lag_hours`, `power_de_load_mw`, `power_es_lag_hours`, `power_es_load_mw`, `power_fr_lag_hours`, `power_fr_load_mw`, `power_hu_lag_hours`, `power_hu_load_mw`, `power_it_lag_hours`, `power_it_load_mw`, `power_nl_lag_hours`, `power_nl_load_mw`, `power_pl_lag_hours`, `power_pl_load_mw`, `power_se_lag_hours`, `power_se_load_mw`, `traffic_budapest_delay_pct`, `traffic_london_delay_pct`, `traffic_losangeles_delay_pct`, `traffic_losangeles_seconds_measured`, `traffic_losangeles_travel_index`.
