...
Generated **2026-09-15 18:51 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **290 snapshots** over 321.6 hours (13.4 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-15/1850.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-15 18:50 UTC`
- 290 of ~322 expected hourly readings
- **13 gaps over two hours:**
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/290 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/290 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/290 | never returned a number |
| 🔴 | `deviations` | 0/290 | never returned a number |
| 🔴 | `listings_uk_ps5_pro` | 186/290 | frozen at 100 for all 24 readings |
| 🔴 | `listings_uk_xbox_series_x` | 186/290 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5` | 186/290 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_ps5_pro` | 186/290 | frozen at 100 for all 24 readings |
| 🔴 | `listings_us_xbox_series_x` | 186/290 | frozen at 100 for all 24 readings |
| 🔴 | `polymarket_market_count` | 250/290 | frozen at 6 for all 24 readings |
| 🔴 | `traffic_london_delay_pct` | 278/290 | zero in 17 of 24 readings |
| 🔴 | `traffic_losangeles_delay_pct` | 191/290 | zero in 16 of 24 readings |
| 🔴 | `traffic_newyork_delay_pct` | 278/290 | zero in 11 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 278/290 | zero in 14 of 24 readings |
| 🔴 | `yt_subscribers` | 286/290 | frozen at 1.37e+07 for all 24 readings |
| 🟠 | `hn_items_per_hour` | 264/290 | missing 10 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 202/290 | missing 12 of 24 since it started |
| 🟠 | `yt_EiQEBYDox_k_views_per_hour` | 235/290 | missing 10 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_likes_per_hour` | 232/290 | missing 10 of 24 since it started |
| 🟠 | `yt_QdBZY2fkU-0_views_per_hour` | 262/290 | missing 10 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 207/290 | missing 10 of 24 since it started |
| 🟠 | `yt_VQRLujxTm3c_views_per_hour` | 235/290 | missing 10 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_likes_per_hour` | 229/290 | missing 10 of 24 since it started |
| 🟠 | `yt_qq76pQsI1iw_views_per_hour` | 235/290 | missing 10 of 24 since it started |
| 🟠 | `yt_rockstar_views_per_hour` | 264/290 | missing 10 of 24 since it started |
| 🟠 | `yt_subscribers_per_hour` | 264/290 | missing 10 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_likes_per_hour` | 235/290 | missing 10 of 24 since it started |
| 🟠 | `yt_tJbzMqJGH4k_views_per_hour` | 231/290 | missing 10 of 24 since it started |
