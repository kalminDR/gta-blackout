...
Generated **2026-09-07 00:28 UTC** by `state.py`, from the repository itself. Nothing here is written from memory. If it disagrees with any other document, this file is right and the other document is stale.

## Where we are

- **10 sources working**, 0 failing, 2 waiting on a key
- **1 planned sources have no code at all**: chicago
- **121 snapshots** over 111.2 hours (4.6 days); last one 0.0 h ago

## Sources

Newest snapshot: `data/2026-09-07/0027.json`
...
- First: `2026-09-02 09:14 UTC` · Last: `2026-09-07 00:27 UTC`
- 121 of ~112 expected hourly readings
...
|---|---|---|---|
| 🔴 | `bestbuy_*` (6 metrics) | 0/121 | never returned a number — source not authenticating |
| 🔴 | `power_*` (3 metrics) | 0/121 | never returned a number — source not authenticating |
| 🔴 | `baseline_quality` | 0/121 | never returned a number |
| 🔴 | `deviations` | 0/121 | never returned a number |
| 🔴 | `polymarket_market_count` | 81/121 | frozen at 6 for all 24 readings |
| 🔴 | `steam_rank_gta5_enh` | 115/121 | frozen at 20 for all 24 readings |
| 🔴 | `traffic_budapest_delay_pct` | 116/121 | zero in 13 of 24 readings |
| 🔴 | `traffic_london_delay_pct` | 109/121 | zero in 14 of 24 readings |
| 🔴 | `traffic_newyork_delay_pct` | 109/121 | zero in 11 of 24 readings |
| 🔴 | `traffic_warsaw_delay_pct` | 109/121 | zero in 16 of 24 readings |
| 🔴 | `twitch_gta5` | 118/121 | zero in 15 of 24 readings |
| 🔴 | `yt_QdBZY2fkU-0_likes_per_hour` | 73/121 | never returned a number |
| 🔴 | `yt_rockstar_views_per_hour` | 105/121 | zero in 22 of 24 readings |
| 🔴 | `yt_subscribers` | 117/121 | frozen at 1.37e+07 for all 24 readings |
| 🔴 | `yt_subscribers_per_hour` | 105/121 | frozen at 0 for all 24 readings; zero in 24 of 24 readings |
| 🟠 | `yt_EiQEBYDox_k_likes_per_hour` | 62/121 | missing 9 of 21 since it started |
| 🟠 | `yt_VQRLujxTm3c_likes_per_hour` | 50/121 | missing 6 of 9 since it started |
...
Baseline needs 6 samples per hour-of-week bucket. **1 of 168 buckets qualify** (110 seen at all). Nulls here are correct behaviour, not a bug: the page refuses to print a number it cannot support.
